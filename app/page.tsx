...
import { describeManualSourceLinkHost, listEvidenceHandoffSourceSuggestions, listManualSourceNameSuggestions } from "./manual-source-options";
...
export default function Home() {
  ...
  const manualSourceLinkHostHint = useMemo(() => describeManualSourceLinkHost(manualEvidenceDraft.sourceName, manualEvidenceDraft.canonicalUrl, manualHandoffSourceSuggestions), [manualEvidenceDraft.sourceName, manualEvidenceDraft.canonicalUrl, manualHandoffSourceSuggestions]);
