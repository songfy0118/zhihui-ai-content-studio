...
const REQUIRED_TABLES = [
  "platform_text_draft_review_receipts",
  "platform_text_draft_review_platforms",
];
...
export function assessPlatformTextDraftReviewMigrationPreflight({
  hosting,
  migrationTag,
  migrationSql,
  storageStatus,
  ...
  if (migrationTag !== "0009_chunky_praxagora") blockers.push("platform_text_draft_review_migration_tag_invalid");
  ...
  if (createdTables.length !== REQUIRED_TABLES.length || createdUniqueIndexes.length !== REQUIRED_UNIQUE_INDEXES.length) blockers.push("platform_text_draft_review_migration_incomplete");
