...
export function buildD1ChainPlan({ journalEntries = [], migrations = [], liveStatus = null } = {}) {
  ...
  const expectedOrder = ["0000_serious_tinkerer", "0001_modern_hydra", "0002_shiny_spitfire", "0003_faithful_harry_osborn", "0004_strange_doorman", "0005_jazzy_toad", "0006_amused_vulture", "0007_silly_turbo", "0008_overconfident_vance_astro", "0009_chunky_praxagora", "0010_tranquil_donald_blake", "0011_living_logan", "0012_kind_emma_frost"];
